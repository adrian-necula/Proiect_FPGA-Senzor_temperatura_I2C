...
# BTNR - reset counter
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btn_count_reset }]; #IO_L9P_T1_DQS_14 Sch=btnc

#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { BTNU }]; #IO_L4N_T0_D05_14 Sch=btnu

# BTND - decrementare
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { btn_dec }]; #IO_L12P_T1_MRCC_14 Sch=btnl

# BTNU - incrementare
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { btn_inc }]; #IO_L10N_T1_D15_14 Sch=btnr
...
# USB-UART TX -> FPGA RX
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { uart_rx_in }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
